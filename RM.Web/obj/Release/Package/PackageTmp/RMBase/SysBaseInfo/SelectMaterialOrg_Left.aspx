<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectMaterialOrg_Left.aspx.cs" Inherits="RM.Web.RMBase.SysBaseInfo.SelectMaterialOrg_Left" %>
    ...
    <script type="text/javascript">
        ...
        function GetClickValue() {
            $(".strTree li div").click(function () {
                ...
                var path = 'SelectMaterialOrg_List.aspx?MaterialType_ID=' + id;
