    ...
    <script type="text/javascript">
        ...
        function audit() {
           ...
           // var JsonStr = JSON.stringify(data);
            auditConfig('/Ajax/Audit_Button.ashx', data)
        ...
        //取消退回审核
        function OpenClose() {
            auditReturnConfig('/Ajax/AuditReturn_Button.ashx', data)
        }
                ...
                <asp:Repeater ID="rp_Item" runat="server" OnItemDataBound="rp_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 50px; text-align: center;">
                             <a href="../MMS_Requisition/Requisition_Form.aspx?Audit=True&&ID=<%#Eval("ID")%>" target=_blank >详细信息</a>
                            </td>
