...
<body>
    ...
    <div class="btnbarcontetn">
        <div style="float: left;">
            ...
            库存大于0：
            <asp:CheckBox ID="chkzero" runat="server" OnCheckedChanged="chkzero_CheckedChanged" AutoPostBack="true"/>
            查询日期：<asp:TextBox ID="searchDate" runat="server"  class="txt"  style="width: 115px;"
