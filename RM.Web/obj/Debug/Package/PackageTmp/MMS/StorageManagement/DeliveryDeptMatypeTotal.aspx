    ...
    <form id="form1" runat="server">
     ...
     <div class="btnbarcontetn">
        <div style="float: left;">
            物料类别:
            <asp:DropDownList ID="ddlMaterialType" runat="server" OnSelectedIndexChanged="ddlMaterialType_SelectedIndexChanged"></asp:DropDownList>
            物料名称：
               <asp:TextBox ID="ttbMateriay_Name" runat="server"  class="txt"  style="width: 115px;"></asp:TextBox>
            领料部门：<asp:DropDownList ID="ddlDeptName" runat="server" ></asp:DropDownList>
            查询日期:
