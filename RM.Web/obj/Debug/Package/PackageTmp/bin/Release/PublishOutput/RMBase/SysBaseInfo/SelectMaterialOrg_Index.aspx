<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectMaterialOrg_Index.aspx.cs" Inherits="RM.Web.RMBase.SysBaseInfo.SelectMaterialOrg_Index" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            iframeresize();
            Loading(true);
            $("#target_right").attr("src", "SelectMaterialOrg_List.aspx");
            $("#target_left").attr("src", "SelectMaterialOrg_Left.aspx");
        })
        /**自应高度**/
